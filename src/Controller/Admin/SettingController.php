...
class SettingController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin/setting/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('admin/admin/setting/new.html.twig', [
            'setting' => $setting,
    ...
    {
        return $this->render('admin/admin/setting/show.html.twig', [
            'setting' => $setting,
        ]);
    }
    ...
    public function edit(Request $request, Setting $setting): Response
    {
        ...
        return $this->render('admin/admin/setting/edit.html.twig', [
            'setting' => $setting,
            'form' => $form->createView(),
        ]);
    }
